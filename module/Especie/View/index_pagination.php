...
<div class="container">
    ...
    <div class="row" style="margin-bottom: 20px;">
        <div class="col-md-12">
            <a href="<?=base_url('especie/cadastrar');?>" class="btn btn-success" style="float: right;">Adicionar</a>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
            <table id="table-list" class="table table-striped table-bordered">
                ...
                <tbody>
                <?php
                if(isset($especies) && !empty($especies)):
                    ...
                    ?>
                    <tr>
                        <td colspan="2"> Não  existem dados no momento</td>
                    </tr>
